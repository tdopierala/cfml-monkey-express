<--- --------------------------------------------------------------------------------------- ----
	...
	Link:
	http://www.bennadel.com/index.cfm?event=blog.view&id=435
...
<cfsavecontent variable="strExcelData">
	...
	<tr>
		...
		<td class="header">Wprowadzone</td>
		<td class="header">Odrzucone</td>
		<td class="header">Archiwum</td>
		<td class="header">Zaakceptowane</td>
		<td class="header">Zaakceptowane warunkowo</td>
	</tr>
	</table>
