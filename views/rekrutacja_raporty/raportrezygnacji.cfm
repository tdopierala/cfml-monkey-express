...
<div class="leftWrapper">
	...
	<div class="headerArea">
		<div class="headerArea uiHeader">
			<h3 class="uiHeaderTitleSmall">Ilość rezygnacji</h3>
		</div>
	</div>
		...
		<div class="contentArea uiContent">
			...
			<table class="uiTable">
				...
				<tbody>
					...
					<tr>
						<td class="leftBorder bottomBorder rightBorder l">Ilość rezygnacji (NIE)</td>
						<td class="bottomBorder rightBorder r">#iif(Len(tak) EQ 0, 0, nie)#</td>
					</tr>
					</cfoutput>
				</tbody>
			</table>
