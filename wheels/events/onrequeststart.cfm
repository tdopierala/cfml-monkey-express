<cffunction name="onRequestStart" returntype="void" access="public" output="false">
	...
	<cfscript>
		...
		{
			$simpleLock(execute="onApplicationStart", name="wheelsReloadLock2", type="exclusive", timeout=180);
		}
		...
		$simpleLock(execute="$runOnRequestStart", executeArgs=arguments, name="wheelsReloadLock2", type="readOnly", timeout=180);
	</cfscript>
</cffunction>
